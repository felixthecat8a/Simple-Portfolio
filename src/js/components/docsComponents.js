...
class DocsCode extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="docs-code">
        <div class="docs-code-header">${title}</div>
...
class DocsCode01 extends HTMLElement {
  static get observedAttributes() {
    return ["lang", "title"];
  }
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="docs-code">
        <div class="docs-code-header">${title}</div>
        <pre><code class="language-${lang}"> ${this.code} </code></pre>
      </div>
    `;
  }
}

customElements.define("docs-code-one", DocsCode01);
